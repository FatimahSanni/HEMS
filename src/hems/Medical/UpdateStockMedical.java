...
public class UpdateStockMedical extends javax.swing.JFrame {

    private Connection conn = null;
    private PreparedStatement pst = null;
    private ResultSet rs = null;
    private final StockTableModel stockTableModel;
    private final TableRowSorter<StockTableModel> sorter;
    
    public UpdateStockMedical() throws SQLException {
        initComponents();
    ...
    String populateQuery = "SELECT * FROM MEDICAL";
        try {
            ...
            Logger.getLogger(UpdateStockMedical.class.getName()).log(Level.SEVERE, null, ex);
        }
}
    ...
    private void stockTableKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_stockTableKeyReleased
        // TODO add your handling code here:
        String insertQuantity = "UPDATE MEDICAL SET quantity = ? WHERE DESCRIPTION = ?";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateStockMedical.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                new UpdateStockMedical().setVisible(true);
            } catch (SQLException ex) {
                Logger.getLogger(UpdateStockMedical.class.getName()).log(Level.SEVERE, null, ex);
            }
        });
