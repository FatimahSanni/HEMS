...
class MediTableModel extends DefaultTableModel{
    public MediTableModel(){    
    }
...
class MediPaymentTableModel extends DefaultTableModel{
    public MediPaymentTableModel(){
...
public class Medical extends javax.swing.JFrame {
    ...
    private MediPaymentTableModel paymentTableModel;
    private final MediTableModel itemTableModel;
    private final JMenuItem deleteItem;
    private final JPopupMenu popupMenu;
    
    public Medical() throws SQLException {
        initComponents();
        ...
        paymentTableModel = new MediPaymentTableModel();
        itemTableModel = new MediTableModel();
...
//        }
    ...
    private void stockNotifier(){
        ...
        String stockQuery = "SELECT * FROM MEDICAL WHERE DESCRIPTION = ?";
        try {
    ...
    private void updateStock() throws SQLException{
        UpdateStockMedical update = new UpdateStockMedical();
...
//                    Logger.getLogger(Optical.class.getName()).log(Level.SEVERE, null, nx);
    ...
    private void addItemButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addItemButtonActionPerformed
        try {
            ...
            AddMedical addnewItem = new AddMedical();
    ...
    private void editItem() throws SQLException{
        EditMedicalItem edit = new EditMedicalItem();
    ...
    private void deductQuantity(){
        int rowCount = paymentTable.getRowCount();
            for(int i = 0; i < rowCount; i++){
                ...
                try {
                    String qtyQuery = "SELECT * FROM MEDICAL WHERE DESCRIPTION = ?";
                    ...
                    if(rs.next()){
                        ...
                        if(qtydb >= quantity){
                            ...
                            String updateQty = "UPDATE MEDICAL SET QUANTITY = ? WHERE DESCRIPTION = ?";
