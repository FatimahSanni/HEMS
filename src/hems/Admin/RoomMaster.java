...
public class RoomMaster extends javax.swing.JFrame {
    ...
    public RoomMaster() throws SQLException {
        initComponents();
    ...
    private void roomTable(){
        ...
        String anaesthesiaQuery = "SELECT * FROM ROOMS";
        try {
            ...
            while(rs.next()){
                ...
                roomTableModel.addRow(new Object[] {code, name});
            }
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
           // add new room to database
            ...
            String insertStatement = "INSERT INTO ROOMS (DESCRIPTION) VALUES (?)";
            try {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                ...
                Logger.getLogger(RoomMaster.class.getName()).log(Level.SEVERE, null, ex);
            }
        });
    }
