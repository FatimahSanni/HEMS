 ...
 * @author Fatimah
 */
class ReligionTableModel extends DefaultTableModel{
    @Override
    public boolean isCellEditable(int row, int column) {
        return false;
    }
}
public class ReligionMaster extends javax.swing.JFrame {

    private Connection conn = null;
    private PreparedStatement pst = null;
    private ResultSet rs = null;
    private final ReligionTableModel religionTableModel;
    private final JPopupMenu popupMenu;
    private final JMenuItem deleteItem;
    public ReligionMaster() throws SQLException {
        initComponents();
        conn = DBUtil.getConnection();
        setLocationRelativeTo(null);
        religionTableModel = new ReligionTableModel();
        religionTableModel.addColumn("ID");
        religionTableModel.addColumn("Religion");
        roomTable.setModel(religionTableModel);
        roomTable();
        ...
        deleteItem.addActionListener((ActionEvent e) -> {
          ...
          religionTableModel.removeRow(row);
        });
    }
    
    //populate room table
    private void roomTable(){
        religionTableModel.setRowCount(0);
        String anaesthesiaQuery = "SELECT * FROM RELIGION";
        try {
            pst = conn.prepareStatement(anaesthesiaQuery);
            rs = pst.executeQuery();
            while(rs.next()){
                int code = rs.getInt("id");
                String name = rs.getString("Religion");
                religionTableModel.addRow(new Object[] {code, name});
            }
        } catch (SQLException ex) {
            Logger.getLogger(ReligionMaster.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void deleteFromDB(){
        ...
        String delete = "DELETE FROM RELIGION WHERE ID = ?";
        try {
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
           // add new room to database
            ...
            String insertStatement = "INSERT INTO RELIGION (RELIGION) VALUES (?)";
            try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReligionMaster.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                new ReligionMaster().setVisible(true);
            } catch (SQLException ex) {
                Logger.getLogger(ReligionMaster.class.getName()).log(Level.SEVERE, null, ex);
            }
        });
