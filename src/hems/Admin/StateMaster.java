 ...
 * @author Fatimah
 */
class StateTableModel extends DefaultTableModel{
    @Override
...
public class StateMaster extends javax.swing.JFrame {
    ...
    private final StateTableModel stateTableModel;
    private final JPopupMenu popupMenu;
    private final JMenuItem deleteItem;
    public StateMaster() throws SQLException {
        initComponents();
        conn = DBUtil.getConnection();
        setLocationRelativeTo(null);
        stateTableModel = new StateTableModel();
        stateTableModel.addColumn("ID");
        stateTableModel.addColumn("State");
        stateTable.setModel(stateTableModel);
        roomTable();
    ...
    private void roomTable(){
        ...
        String anaesthesiaQuery = "SELECT * FROM states";
        try {
            ...
            while(rs.next()){
                ...
                stateTableModel.addRow(new Object[] {code, name});
            }
    ...
    private void deleteFromDB(){
        int row = stateTable.getSelectedRow();
        int id = (Integer)stateTable.getValueAt(row, 0);
        String delete = "DELETE FROM states WHERE ID = ?";
        try {
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
           // add new room to database
            ...
            String insertStatement = "INSERT INTO states (state) VALUES (?)";
            try {
    ...
    private void stateTableMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_stateTableMousePressed
        ...
        int row = stateTable.rowAtPoint(evt.getPoint());
                stateTable.getSelectionModel().addSelectionInterval(row, row);
                if(evt.getButton() == MouseEvent.BUTTON3){           
                popupMenu.show(stateTable, evt.getX(), evt.getY());
                }
