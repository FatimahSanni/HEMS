...
//                    double cost = (Double.parseDouble());
                ...
                ///Input into combined invoice table
//                String insertMain = "INSERT INTO TINVOICE (BillNo, name, MRN, AMOUNT, DESCRIPTION, DATE, MODULE) VALUES (?,?,?,?,?,?,?)";
//                pst4 = conn.prepareStatement(insertMain);
//                String totalString = totalField.getText();
//                Double total = Double.parseDouble(totalString.substring(3));
//                int column = 1;
//                pst4.setString(column++, billno);
//                pst4.setString(column++, pNameField.getText());
//                pst4.setString(column++, mrnField.getText().toUpperCase());
//                pst4.setDouble(column++, total);
//                pst4.setString(column++, "OPTICAL PURCHASED");
//                pst4.setString(column++, date);
//                pst4.setString(column++, "OPTICAL");
//                pst4.executeUpdate();
//                pst4.close();
